 ...
 * "openrouter.ai" carries the UfrenClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__UfrenClawFetchPatched) return;
  globalThis.__UfrenClawFetchPatched = true;

  globalThis.fetch = function UfrenClawFetch(input, init) {
    var url =
