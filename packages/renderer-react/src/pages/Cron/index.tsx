...
function TaskDialog({ job, onClose, onSave }: TaskDialogProps) {
  ...
  return (
    ...
    >
      <Card
        className="w-full max-w-lg max-h-[90vh] flex flex-col rounded-3xl border-0 shadow-2xl bg-card overflow-hidden"
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-4">
          <motion.div
            className="h-[46px] w-[46px] shrink-0 flex items-center justify-center text-foreground bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-full shadow-sm group-hover:scale-105 transition-transform"
            animate={job.enabled ? { y: [0, -2, 0] } : {}}
            transition={
              job.enabled
  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl mx-auto flex flex-col h-full p-10 pt-16">
        ...
        {/* Content Area */}
        <div className="flex-1 overflow-y-auto scroll-container-stable pb-10 min-h-0">
          {/* Gateway Warning */}
          {!isGatewayRunning && (
          ...
          >
            <motion.div
              ...
              className="p-5 rounded-[24px] bg-black/5 dark:bg-white/5 border border-transparent flex flex-col justify-between min-h-[130px] relative overflow-hidden group hover:bg-black/10 dark:hover:bg-white/10 transition-colors"
            >
              ...
              <div className="mt-4 flex items-baseline gap-3">
                <p className="text-[40px] leading-none font-serif text-foreground">
                  {safeJobs.length}
                </p>
          ...
          {safeJobs.length === 0 ? (
            <motion.div
              ...
              className="flex flex-col items-center justify-center py-20 text-muted-foreground bg-black/5 dark:bg-white/5 rounded-3xl border border-transparent border-dashed"
            >
