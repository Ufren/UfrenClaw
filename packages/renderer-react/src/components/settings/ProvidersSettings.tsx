...
const inputClasses = 'h-[44px] rounded-xl font-mono text-[13px] bg-black/5 dark:bg-white/5 border-transparent focus:bg-white dark:focus:bg-black/10 focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:border-blue-500 shadow-sm transition-all text-foreground placeholder:text-foreground/40';
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="space-y-2 pt-1">
                  ...
                  {fallbackOptions.length === 0 ? (
                    ...
                    <div className={cn("space-y-2 rounded-xl border border-black/10 dark:border-white/10 p-3 shadow-sm", isDefault ? "bg-white dark:bg-card" : "bg-black/5 dark:bg-white/5")}>
