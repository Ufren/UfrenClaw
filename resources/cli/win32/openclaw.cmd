...
if /i "%1"=="update" (
    echo openclaw is managed by UfrenClaw ^(bundled version^).
    echo.
    echo To update openclaw, update UfrenClaw:
    echo   Open UfrenClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=UfrenClaw
"%~dp0..\..\UfrenClaw.exe" "%~dp0..\openclaw\openclaw.mjs" %*
